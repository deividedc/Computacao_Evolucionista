...
#from read_data_awoyera import *
#from read_data_mcelroy import *
##from read_data_ggbs import *
#from read_data_taffarello import *
#from read_data_bassenthwaite import *
...
for run in range(run0, n_runs):
    ...
    for dataset in datasets:#[:1]:
        ...
        for tk, tn in enumerate(dataset['target_names']):
            ...
            ub_gmdh=[       1,1,1,1,  1,  12, 0.8, ] #+ [1.0]*n_features
            #------------------------------------------------         
...
#            #---------g---------------------------------------------------------         
            ...
            for (clf_name, lb, ub, fun, args, random_seed) in estimators:
                ...
                #result=dual_annealing(fun_gmdh_fs, list(zip(lb,ub)), args, maxiter=1, maxfun=300, x0=init)
